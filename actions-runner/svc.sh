...
SVC_NAME="actions.runner.kmccarthyhashi-vault-action-exampleapp.kellymccarthy-XXLWDC9HJ7"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (kmccarthyhashi-vault-action-exampleapp.kellymccarthy-XXLWDC9HJ7)"
